        ...
        <div class="card mb-4 shadow-sm">
            ...
            <div class="card-body">
                <div class="form-row">
                    ...
                    <?php $__currentLoopData = $couriers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="courierCheckbox<?php echo e($id); ?>" name="couriers[]" value="<?php echo e($id); ?>">
                            <label class="form-check-label" for="courierCheckbox<?php echo e($id); ?>"><?php echo e($name); ?></label>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Web\cekongkir\resources\views/home.blade.php ENDPATH**/ ?>